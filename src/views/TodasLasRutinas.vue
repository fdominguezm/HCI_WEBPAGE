...
<div>
  <v-main>
    <SubBar/>
    <div class="rout">
     <v-card v-for="routine in result" :key="routine.id" class="card" color= #6797C5>
              <v-col md="auto">
...
export default {
  ...
  methods: {
    ...
    async getAllRoutines() {
      try {
        ...
        const routine = await this.$getAllRoutines(this.controller);
  ...
  async created() {
    ...
    this.result = await routineStore.getAllRoutines();
  },
}
</script>
